...
# function or the calc_reqular_pay function to calculate
...
def main():
    ...
    # Calculate and display the gros pay.
    if hours_worked > BASE_HOURS:
        calc_pay_with_OT(hours_worked, pay_rate)
    else:
        calc_reqular_pay(hours_worked, pay_rate)
...
def calc_pay_with_OT(hours, rate):
    ...
    # Calculate the amount of overime pay.
...
# pay rate as arguments. The gross pay is desplayed.
